...
qualified_usage_dct = {'activity': 'http://partsregistry.org/activites/activity1',
                       'uri': 'http://partsregistry.org/cd/BBa_F2620/usage1',
                       'entity': dnasynthesisactivity_dct['entities'][0][0],
                       'hadRole': dnasynthesisactivity_dct['entities'][0][1]}


qualified_usage_dct = {'activity': 'http://partsregistry.org/activites/activity1',
                       'uri': 'http://partsregistry.org/cd/BBa_F2620/usage1',
                       'entity': dnasynthesisactivity_dct['entities'][1][0],
                       'hadRole': dnasynthesisactivity_dct['entities'][1][1]}
...
add_activity(**dnasynthesisactivity_dct)

add_qualified_association(**qualified_association_dct)

add_qualified_usage(**qualified_usage_dct)
